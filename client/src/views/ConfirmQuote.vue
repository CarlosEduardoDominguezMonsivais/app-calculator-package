<template>
    ...
    <!-- <div class="container"> -->
        <div class="h-screen grid grid-cols-3">
            <div class="lg:col-span-2 col-span-3 bg-gris-default space-y-8 px-12">
                <div class="container">
                    ...
                    <div class="rounded-md">
                        <section>
                            <h2 class="uppercase tracking-wide text-lg font-semibold text-gray-700 my-2">Quote Information</h2>
                            <fieldset class="mb-3 bg-white shadow-lg rounded text-gray-600">
                    ...
                    <div class="flex">
                    <a href="/" class="text-white bg-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded"><i class="fa-solid fa-arrow-left"></i> Return to calculator box</a>
                    <button type="submit" class="ml-auto text-white border-0 py-2 px-8 focus:outline-none bg-blue-900 rounded"><i class="fa-solid fa-paper-plane"></i> Enviar Cotización</button>
                    </div>
                </div>
            </div>
            <div class="col-span-1 bg-white lg:block hidden">
                    ...
                    <li class="grid grid-cols-6 gap-2 border-b-1">
                        ...
                        <div class="col-span-2 pt-3">
                            <div class="flex items-center space-x-2 text-sm justify-between">
                                ...
                                <span class="text-blue-pp font-semibold inline-block">€61.98</span>
                            </div>
                        </div>
                    </li>
                </ul>
                <div class="px-8 border-b">
                    <div class="flex justify-between py-4 text-gray-600">
                        <span>Subtotal</span>
                        <span class="font-semibold text-blue-pp">€846.98</span>
                    </div>
                    <div class="flex justify-between py-4 text-gray-600">
                        <span>Shipping</span>
                        <span class="font-semibold text-blue-pp">Free</span>
                    </div>
                </div>
...
export default {
    ...
    mounted () {
        this.quote_calulate = this.quote;
        console.log(this.quote_calulate)
    }
}
</script>
