      ...
      <template #content>
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div class="bg-white lg:block">
                <ul class="py-6 border-b space-y-6 px-4 md:px-8">
                ...
                <div class="px-4 md:px-8 border-b">
                ...
                <div class="font-semibold text-xl px-4 md:px-8 flex justify-between py-8 text-gray-600">
