<template>
  <section class="text-gray-700 body-font overflow-hidden md:bg-gris-default">
        ...
        <div class="bg-white px-4 md:px-12 py-8">
          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-200 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="py-3 pl-2 md:px-6">
                            Minimo de fabricación
                        </th>
                        <th scope="col" class="py-3 pl-2 md:px-6">
                            Precio por caja
                        </th>
                        <th scope="col" class="py-3 pl-2 pd:px-6">
                            Total
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th scope="row" class="py-4 pl-2 md:px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          {{this.quote_manufacturing.fabricacion_minimo_boxes}} pza
                        </th>
                        <td class="py-4 pl-2 md:px-6">
    ...
    <modal-calculator :toogle="toogleModal">
      <template #header>
...
import ModalCalculator from '../components/ModalCalculator.vue'
